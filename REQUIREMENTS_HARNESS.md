...
| FLH-F-024 | The harness shall emit LLM-generated progress updates at meaningful milestones and expose them as pollable structured events. | The user explicitly wants breadcrumb-style explanations of what the harness is doing and why. | Implemented |
