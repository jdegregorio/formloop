...
_Source: [https://build123d.readthedocs.io/en/latest/key_concepts_algebra.html](https://build123d.readthedocs.io/en/latest/key_concepts_algebra.html)_

_Part of the Build123D knowledge pack (formloop/src/formloop/agents/knowledge/build123d/pages/key_concepts_algebra.md)._
...
- A discussion around performance can be found in [Performance considerations in algebra mode](https://build123d.readthedocs.io/en/latest/algebra_performance.html#algebra-performance).
- A mathematically formal definition of the algebra can be found in [Algebraic definition](https://build123d.readthedocs.io/en/latest/algebra_definition.html#algebra-definition).
...
Details can be found in [Location arithmetic for algebra mode](https://build123d.readthedocs.io/en/latest/location_arithmetic.html#location-arithmetics).
