...
_Source: [https://build123d.readthedocs.io/en/latest/assemblies.html](https://build123d.readthedocs.io/en/latest/assemblies.html)_

_Part of the Build123D knowledge pack (formloop/src/formloop/agents/knowledge/build123d/pages/assemblies.md)._
...
some type of assembly. Once parts have been assembled in a [`Compound`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Compound "topology.Compound") object
they can be treated as a unit - i.e. [`moved()`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape.moved "topology.Shape.moved") or exported.

To create an assembly in build123d, one needs to
create a tree of parts by simply assigning either a [`Compound`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Compound "topology.Compound") object’s `parent` or
`children` attributes. To illustrate the process, we’ll extend the
[Joint Tutorial](https://build123d.readthedocs.io/en/latest/tutorial_joints.html#joint-tutorial).

## Assigning Labels

In order keep track of objects one can assign a `label` to all [`Shape`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape "topology.Shape") objects.
...
Creation of the assembly is done by simply creating a [`Compound`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Compound "topology.Compound") object and assigning
...
To display the topology of an assembly [`Compound`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Compound "topology.Compound"), the [`show_topology()`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape.show_topology "topology.Shape.show_topology")
...
To add to an assembly [`Compound`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Compound "topology.Compound") one can change either `children` or `parent` attributes.
...
Build123d’s implementation of `deepcopy()` for the [`Shape`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape "topology.Shape") class (e.g. `Solid`, `Face`, etc.)
...
very useful as it copies all of the [`Shape`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape "topology.Shape") except for the actual CAD object
...
![_images/reference_assembly.svg](https://build123d.readthedocs.io/en/latest/_images/reference_assembly.svg)
...
[`Shape`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape "topology.Shape") class a sub-class of anytree’s `NodeMixin` class. Doing so
adds the following attributes to [`Shape`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape "topology.Shape"):
...
are stored as immutable `tuple` objects. To add a child to an existing [`Compound`](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Compound "topology.Compound")
...
In the example below, the variable total\_volume holds the sum of all the volumes in each solid in an assembly.
Compare this to assembly3\_volume which only results in the volume of the top level part.
...
The [`pack.pack()`](https://build123d.readthedocs.io/en/latest/assemblies.html#pack.pack "pack.pack") function arranges objects in a compact, non-overlapping layout within a square(ish) 2D area. It is designed to minimize the space between objects while ensuring that no two objects overlap.

pack(*objects: Collection[Shape]*, *padding: float*, *align\_z: bool = False*) → Collection[Shape]
:   Pack objects in a squarish area in Plane.XY.

    Parameters:
    :   - **objects** (*Collection**[*[*Shape*](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape "topology.Shape")*]*) – objects to arrange
        - **padding** (*float*) – space between objects
        - **align\_z** (*bool**,* *optional*) – align shape bottoms to Plane.XY. Defaults to False.

    Returns:
    :   rearranged objects

    Return type:
    :   *Collection*[[*Shape*](https://build123d.readthedocs.io/en/latest/direct_api_reference.html#topology.Shape "topology.Shape")]
...
![_images/pack_demo_initial_state.svg](https://build123d.readthedocs.io/en/latest/_images/pack_demo_initial_state.svg)
...
![_images/pack_demo_packed_xy.svg](https://build123d.readthedocs.io/en/latest/_images/pack_demo_packed_xy.svg)
...
![_images/pack_demo_packed_z.svg](https://build123d.readthedocs.io/en/latest/_images/pack_demo_packed_z.svg)
